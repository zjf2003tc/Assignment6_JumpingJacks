...
#### Standard deviation and sum.diff were dropped from the kmeans model because they seemed to be highly correlated with range.
...
dat.plot %>% ggplot + geom_col(mapping = aes(x = name, y = PC1,fill=name)) + labs(x = "Name", y = "PC1", title = "PC1 vs. Jumping Jacks by Person")
```
